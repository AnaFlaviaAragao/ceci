...
int main() {
  std::fstream vectorFile("../simulation/modelsim/addac_1.tv",
                          std::fstream::out);
  ...
  vectorFile << clk << "_" << sel0 << "_" << sel1 << "_" << a << "_"
             << addac.getCin() << "_" << S << "_" << cout << "_"
             << addac.getAcc() << std::endl;
  ...
  std::tie(S, cout) = addac.solve(a, sel0, sel1, clk, reset, cin);
  // vectorFile << clk << "_" << sel0 << "_" << sel1 << "_" << a << "_" <<
  // addac.getCin() << "_" << S << "_" << cout << "_" << addac.getAcc() <<
  // std::endl;
